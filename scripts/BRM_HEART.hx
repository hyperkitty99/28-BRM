...
function onCreate():Void {
    add(healthBG = new BGSprite('healthMonitor', 700, 502, 0, 0, ['healthMonitor'], false));
    add(fysIcon = new BGSprite('healthMonitor', 893, 600, 0, 0, ['fys', 'dead'], false));

    for (i in 0...3) {
        var heartSpr = new BGSprite('healthMonitor', 760 + (i * 35), 665, 0, 0, ['heart', 'heart half', 'no heart']);
